...
## 1. Project Overview
This project analyses Amazon customer shopping behaviour to understand purchase trends, customer preferences, and payment patterns. By combining SQL for data cleaning & data extraction and Power BI for visualization, the project provides actionable insights to help improve business decision-making and marketing strategies.

## 2. Objective
The objective of this project is to **analyse customer shopping behaviour** and provide **actionable insights** to support business decision-making. The analysis focuses on three main areas:  
- **Purchase Trends:** Identify top-selling categories, popular sizes, and seasonal patterns.  
- **Customer Segmentation:** Analyse purchasing patterns based on subscription status, payment methods, and demographics.  
...
- **Sales by Colour:** Green, Teal, Yellow, Olive, Cyan, and Violet are the top-selling colours (~10–11K sales each).  
...
- Ensure inventory is optimised for popular sizes (Medium & Large) and top-selling colours.  
- Highlight peak seasonal periods in marketing campaigns to maximise sales.  
...
4. Run `Analysis.sql` and `views.sql` to prepare aggregated tables and views for visualisation.  
5. Import the processed data into Power BI to create dashboards and visualisations.  
...
3. **Analysis:** Wrote SQL queries for top categories, payment methods, subscription analysis, seasonal sales, sizes, and colours.  
4. **Views Creation:** Created SQL views for simplified Power BI import.  
5. **Power BI Import:** Imported SQL views into Power BI.  
6.  **Basic Cleaning in Power BI:** Renamed columns, adjusted data types and applied DAX measures for calculations.  
7. **Dashboard Development:** Built interactive dashboards with charts, tables, slicers, and KPIs.  
8. **Insights and Recommendations:** Derived key findings and formulated recommendations based on dashboard analysis.  
